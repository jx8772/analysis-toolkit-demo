...
public class SentimentAnalysis {
	...
	public static void nnClassify(String train_table, String test_table) throws Exception {
		 ...
		 try {
			...
			*/
			 ...
			 //train and make predictions
			 fc.buildClassifier(string_train_data);
			//NaiveBayesMultinomial nbm2 = new NaiveBayesMultinomial();
	...
	public static void main(String[] args) throws Exception {
		 pnClassify("pn_emoticon_train","tuberculosis_tweets");
		 nnClassify("train_tweets_sentiment_bal", "tuberculosis_tweets");
