package analysis.toolkit.demo.example.mongodb;
...
public class MongoDB {
    public static void main(String[] args) {
        try {
            ...
            //get the collection user, insert a document with 3 fields: name, age, and createdDate
            /*
            ...
            //get the collection user, query the mongo db with age = 21        
            /*
            DBCollection table = db.getCollection("user");
